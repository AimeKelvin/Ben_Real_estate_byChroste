<?php
    ...
    if(isset($_GET['land'])) {
      ...
      $landing_title = $output_fetch['landing_title'];
    ...
    <div class="section">
      <div class="container">
        <div class="row justify-content-between">
              ...
              <div class="img-property-slide">
                <?php
                    ...
                    foreach(json_decode($output_fetch['images']) as $image) {
                            echo '
                                <img src="./includes/admin/uploaded_landings/' .$image. '" alt="Image" class="img-fluid" />
          ...
          <div class="col-lg-4">
            <h2 class="heading text-primary"><?php echo $landing_title; ?></h2>
            <p class="meta"><?php echo $output_fetch['location']; ?></p>
            <p class="text-black-50">
              <?php echo $output_fetch['landing_des']; ?>
            </p>
            
            <div style="margin-bottom: 30px;">
                <div class="specs d-flex mb-4">
                  <span class="d-block d-flex align-items-center me-3">
                    <span class="caption"><?php echo $output_fetch['landing_size']; ?></span>
                  </span>
            ...
            <div>
              ...
              <form action="./includes/admin/add_new_deal.php" method="POST">
                <div>
                  <input type="text" style="display: none;" name="listing_name" value="<?php echo $output_fetch['landing_title']; ?>">
                </div>
