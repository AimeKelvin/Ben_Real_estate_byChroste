    ...
    <div class="w-full h-[100vh]">
        ...
        <div class="w-full h-full flex flex-row items-center">
            ...
            <div class="h-full w-full p-[10px] md:p-[40px] pb-[50px] overflow-y-scroll md:w-[85%]">
                <div class="text-[18px] font-black text-slate-300 select-none mb-[30px]"><?php echo $output_fetch['car_name']; ?></div>
                <?php
                    $car_id = $_GET['id'];
                        ...
                        foreach(json_decode($output_fetch['images']) as $image) {
                                echo '
                                    <div class="w-full h-[200px] rounded-[12px]">
                                        <img src="../../includes/admin/uploaded_cars/' .$image. '" class="w-full h-full object-cover object-center" alt="Image 1">
                                    </div>
                                ';
                        }
