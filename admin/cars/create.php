        ...
        <div class="w-full h-full flex flex-row items-center">
            ...
            <div class="h-full w-full p-[10px] md:p-[40px] pb-[50px] overflow-y-scroll md:w-[85%]">
                ...
                <div class="w-full flex flex-row items-center space-x-[20px] mt-[10px] mb-[20px]">
                    <div><a href="#" class="bg-blue-500 pr-[12px] pl-[12px] pt-[8px] pb-[8px] rounded-[14px] focus:outline-[2px] outline-offset-2 outline-red-500 text-white font-bold"><i class="fa-solid fa-car text-white font-bold"></i><span></span> <span class="hidden md:inline-flex">Add Vehicle</span></a></div>
                    ...
                    <div><a href="../landings/create.php" class="bg-blue-300 pr-[12px] pl-[12px] pt-[8px] pb-[8px] rounded-[14px] focus:outline-[2px] outline-offset-2 outline-red-500 text-white font-bold"><i class="fa-solid fa-building text-white font-bold"></i><span></span> <span class="hidden md:inline-flex">Add Landing</span></a></div>
                </div>
                <!--No of images-->
                ...
                <div class="flex flex-col space-x-[0px] w-full space-y-[10px] justify-between items-start md:flex-row md:space-x-[20px] md:space-y-[0px]">
                    ...
                    <div class="w-full md:w-[50%]">
                        ...
                        <form action="../../includes/admin/upload_car_inc.php" method="POST" enctype="multipart/form-data">
                            <div class="flex flex-col space-y-[12px]">
                                <div><input type="file" class="hidden" id="file" onchange="preview()" name="car_image[]" accept=".jpg, .jpeg, .png" multiple></div>
                                <div>
                                    <input type="text" class="border-[1px] border-solid border-gray-300 text-slate-600 w-full pl-[15px] pr-[10px] pt-[10px] pb-[10px] rounded-[6px] focus:outline-[2px] focus:outline-offset-[2px] focus:outline-solid focus:outline-blue-500 outline-0" placeholder="Car Name" name="car_name">
                                </div>
                                <div>
                                ...
                                <div>
                                    <input type="text" class="border-[1px] border-solid border-gray-300 text-slate-600 w-full pl-[15px] pr-[10px] pt-[10px] pb-[10px] rounded-[6px] focus:outline-[2px] focus:outline-offset-[2px] focus:outline-solid focus:outline-blue-500 outline-0" placeholder="Kilometres" name="kilometres">
                                </div>
                                <div>
                                ...
                                <div>
                                    <div><button type="submit" name="add_car_btn" class="bg-blue-500 w-full pr-[12px] pl-[12px] pt-[8px] pb-[8px] rounded-[14px] focus:outline-[2px] outline-offset-2 outline-red-500 text-white font-bold">Add Product</button></div>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 space-x-[4px]">
                        <?php
                            ...
                            if(mysqli_num_rows($result) > 0) {
                                    ...
                                    echo '
                                        <div class="w-full bg-white/[90%] p-[5px] rounded-[4px] md:w-[100%] flex flex-col">
                                            ...
                                            <div class="p-[10px] rounded-[4px]">
                                                ...
                                                <a href="single_listing_car.php?id=' .$fetch['id']. '" class="font-md text-[14px] text-blue-300 select-none text-start">View Listing <span></span><i class="fa-solid fa-arrow-right"></i></a>
                                            </div>
                                        </div>
                                ...
                                echo '
                                    <div class="text-[18px] text-center font-black text-slate-900 select-none md-[4px]">No Cars Added</div>
