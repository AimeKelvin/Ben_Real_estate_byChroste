        ...
        <div class="w-full h-full flex flex-row items-center">
            ...
            <div class="h-full w-full p-[10px] md:p-[40px] pb-[50px] overflow-y-scroll md:w-[85%]">
                ...
                <div class="flex flex-col space-x-[0px] w-full space-y-[10px] justify-between items-start md:flex-row md:space-x-[20px] md:space-y-[0px]">
                    <div class="w-full md:w-[50%] border-[1px] border-solid border-gray-300 rounded-[15px] h-[300px] flex flex-col justify-center items-center p-[20px]">
                    ...
                    <div class="w-full md:w-[50%]">
                        ...
                        <form action="" method="" enctype="multipart/form-data">
                            <div class="flex flex-col space-y-[12px]">
                                <div><input type="file" class="hidden" id="file" name="product-image"></div>
                                <div>
                                    <input type="text" class="border-[1px] border-solid border-gray-300 text-slate-600 w-full pl-[15px] pr-[10px] pt-[10px] pb-[10px] rounded-[6px] focus:outline-[2px] focus:outline-offset-[2px] focus:outline-solid focus:outline-blue-500 outline-0" placeholder="Product Title" name="product-title">
                                </div>
                                <div>
                                    <textarea name="description" placeholder="Product Description" class="border-[1px] border-solid border-gray-300 text-slate-600 w-full h-[150px] pl-[15px] pr-[10px] pt-[10px] pb-[10px] rounded-[6px] focus:outline-[2px] focus:outline-offset-[2px] focus:outline-solid focus:outline-blue-500 outline-0 id=""></textarea>
                                </div>
                                <div class="flex flex-row no-wrap space-x-[40px] items-center">
                                    ...
                                    <div class="flex flex-row items-center space-x-[6px]">
                                        <input type="radio" id="sale" name="status">
                                        <label for="sale" class="text-slate-500 text-md">For Sale</label>
                                    </div>
                                </div>
                                <div>
                                    <div><button class="bg-blue-500 w-full pr-[12px] pl-[12px] pt-[8px] pb-[8px] rounded-[14px] focus:outline-[2px] outline-offset-2 outline-red-500 text-white font-bold">Add Product</button></div>
                                </div>
                            </div>
                        </form>
                    </div>
