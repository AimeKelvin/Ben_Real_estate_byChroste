    ...
    <div class="w-full h-[100vh]">
        ...
        <div class="w-full h-full flex flex-row items-center">
            ...
            <div class="h-full w-full p-[10px] md:p-[40px] pb-[50px] overflow-y-scroll md:w-[85%]">
                <div class="text-[18px] font-black text-slate-300 select-none mb-[30px]"><?php echo $output_fetch['house_title']; ?></div>
                <?php
                    $car_id = $_GET['id'];
                        ...
                        foreach(json_decode($output_fetch['images']) as $image) {
                                echo '
                                    <div class="w-full h-[200px] rounded-[12px]">
                                        <img src="../../includes/admin/uploaded_houses/' .$image. '" class="w-full h-full object-cover object-center" alt="Image 1">
                                    </div>
                                ';
                        }
                ...
                <div class="mt-[30px]">
                    <div class="flex space-x-[20px] items-center">
                        ...
                        <div>
                            <form action="../../includes/admin/update_house_inc.php" method="POST">
                                <input type="hidden" name="house_id" value="<?php echo $output_fetch['id']; ?>">
                                <input type="hidden" name="price" value="<?php echo $output_fetch['house_price']; ?>">
                    ...
                    <div class="w-full md:w-[50%]">
                        ...
                        <form action="../../includes/admin/update_house_inc.php" method="POST" enctype="multipart/form-data">
                            <div class="flex flex-col space-y-[12px]">
                                ...
                                <div>
                                    <div><button type="submit" name="update_house_btn" class="bg-blue-500 w-full pr-[12px] pl-[12px] pt-[8px] pb-[8px] rounded-[14px] focus:outline-[2px] outline-offset-2 outline-red-500 text-white font-bold">Update House</button></div>
                                </div>
                            </div>
                        </form>
                    </div>
