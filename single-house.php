<?php
  include './config/db.php';
    ...
    if(isset($_GET['house'])) {
      ...
      $house_des = $output_fetch['house_des'];
...
<html lang="en">
  <head>
    ...
    <title><?php echo $house_title; ?></title>
  </head>
  <body>
    ...
    <div class="section">
      <div class="container">
        <div class="row justify-content-between">
              ...
              <div class="img-property-slide">
                <?php
                    ...
                    foreach(json_decode($output_fetch['images']) as $image) {
                            echo '
                                <img src="./includes/admin/uploaded_houses/' .$image. '" alt="Image" class="img-fluid" />
          ...
          <div class="col-lg-4">
            <h2 class="heading text-primary"><?php echo $house_title; ?></h2>
            ...
            <div>
              ...
              <form action="./includes/admin/add_new_deal.php" method="POST">
                <div>
                  <input type="text" style="display: none;" name="listing_name" value="<?php echo $output_fetch['house_title']; ?>">
                </div>
